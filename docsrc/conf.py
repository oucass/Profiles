...
latex_documents = [
    (master_doc, 'Profiles.tex', u'Profiles Documentation',
     u'Jessica Blunt, Brian Greene, Tyler Bell, Gus Azevedo, and Ariel Jacobs', 'manual'),
]
...
man_pages = [
    (master_doc, 'profiles', u'Profiles Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Profiles', u'Profiles Documentation',
     author, 'Profiles', 'One line description of project.',
     'Miscellaneous'),
]
...
html_context['github_user'] = 'oucass'
html_context['github_repo'] = 'Profiles'
